...
public interface Field {
	 ...
	 * 
	 * @param pos
	 *            the position where a torpedo is fired.
	 * @return true if a ship or part of a ship was hit. False otherwise
	 * @throws IllegalArgumentException
	 *             if x or y are outside of the field area
	 */
	public FireResult fire(Position pos) throws IllegalArgumentException;
	 ...
	 *            the ship to be put
	 * @param pos
	 *            the position where a ship is placed
	 * @throws IllegalArgumentException
	 *             if x or y are outside the field area
	 */
	 ...
	 * 
	 * @param shape
	 *            the battleship to be checked
	 * @param pos
	 *            the position to check the ship at
